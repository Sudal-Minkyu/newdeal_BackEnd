...
import com.broadwave.backend.lifetime.all.LifeAllTime;
import com.broadwave.backend.lifetime.all.LifeAllTimeDto;
import com.broadwave.backend.lifetime.all.LifeAllTimeMapperDto;
import com.broadwave.backend.lifetime.all.LifeAllTimeService;
...
public class LifeDetailTimeRestController {
    ...
    @Autowired
    public LifeDetailTimeRestController(ModelMapper modelMapper, AbsenceService absenceService, LifeAllTimeService lifeAllTimeService, KeyGenerateService keyGenerateService) {
