...
//    private final ModelMapper modelMapper;
    ...
    @Autowired
    public PerformanceRestController(PerformanceService performanceService,KeyGenerateService keyGenerateService) {
...
//        }
        ...
        String autoNum = keyGenerateService.keyGenerate("nd_pi_input", yyMM.format(now), "admin"); // currentuserid
        ...
        for (int i=3; i<5; i++){
            ...
            performance.setInsertDateTime(LocalDateTime.now()); // currentuserid 작성날짜
            performance.setInsert_id("admin"); // currentuserid 작성자
