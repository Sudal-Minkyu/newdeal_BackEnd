...
public class PerformanceMiddleSaveBusinessDto {
    ...
    private String piBusinessValidity1; // 사업추진 타당성 첫번째 대안
    private String piBusinessValidity2; // 사업추진 타당성 두번째 대안
    private String piBusinessValidity3; // 사업추진 타당성 세번째 대안
    private String piBusinessValidity4; // 사업추진 타당성 네번째 대안
//
